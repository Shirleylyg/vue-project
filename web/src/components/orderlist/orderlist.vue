<template>
  <div>
      <div class="orderlist">
            ...
            <ul v-show="ul1">
                <li v-for="(obj,index) in goods" v-if="obj.status==0" class="goodslist"  v-on:click="cli(obj.order_id)">
            ...
            <ul v-show="ul2">
            <li  class="goodslist" v-for="(obj,index) in goods" v-if="obj.status==1"  v-on:click="cli(obj.order_id)">
                  <div class="hoteltitle"><span class="htitle">酒店名称</span>{{obj.title}}</div>
                  <div class="checktimes">
